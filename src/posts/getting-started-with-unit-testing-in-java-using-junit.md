...
<Image class="inline-basic-image" src="images/getting-started-with-unit-testing-in-java-using-junit/getting-started-with-unit-testing-in-java-using-junit-screenshot-1.png" />
</ImageCaption>
...
<ImageCaption>
<Image class="inline-basic-image" src="images/getting-started-with-unit-testing-in-java-using-junit/getting-started-with-unit-testing-in-java-using-junit-screenshot-2.png" />
</ImageCaption>

<ImageCaption>
    <Image class="inline-basic-image" src="images/getting-started-with-unit-testing-in-java-using-junit/getting-started-with-unit-testing-in-java-using-junit-screenshot-3.png" />
</ImageCaption>
...
<ImageCaption>
    <Image class="inline-basic-image" src="images/getting-started-with-unit-testing-in-java-using-junit/getting-started-with-unit-testing-in-java-using-junit-screenshot-4.png" />
</ImageCaption>

Here are the results of the tests:
<ImageCaption>
<Image class="inline-basic-image" src="images/getting-started-with-unit-testing-in-java-using-junit/getting-started-with-unit-testing-in-java-using-junit-screenshot-5.png" />
</ImageCaption>
...
<ImageCaption>
<Image class="inline-basic-image" src="images/getting-started-with-unit-testing-in-java-using-junit/getting-started-with-unit-testing-in-java-using-junit-screenshot-6.png" />
</ImageCaption>
